...
class ZynqMP_AMD_Vivado_logicc_Block_Project_Model(Block_Project_Model):
...
class ZynqMP_AMD_Vivado_logicc_Block_Model(Block_Model):
    ...
    project: ZynqMP_AMD_Vivado_logicc_Block_Project_Model


class ZynqMP_AMD_Vivado_logicc_Blocks_Model(BaseModel):
    model_config = ConfigDict(extra="ignore")

    vivado: ZynqMP_AMD_Vivado_logicc_Block_Model = Field(
        default=..., description="Configuration of the AMD Vivado with HDL on git (Hog) block for ZynqMP devices"
    )


class ZynqMP_AMD_Vivado_logicc_Model(ZynqMP_Base_Model):
    model_config = ConfigDict(extra="forbid", strict=True)
