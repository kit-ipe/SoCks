...
class ZynqMP_AMD_PMUFW_Builder_Alma9(AMD_Builder):
    ...
    def __init__(self, project_cfg: dict, project_cfg_files: list, socks_dir: pathlib.Path, project_dir: pathlib.Path, block_id: str = 'pmu-fw', block_description: str = 'Build the Platform Management Unit (PMU) Firmware for ZynqMP devices'):
    ...
    def create_pmufw_project(self):
        ...
        create_pmufw_project_commands = f'\'export XILINXD_LICENSE_FILE={self._amd_license} && ' \
    ...
    def build_pmufw(self):
        ...
        pmufw_build_commands = f'\'export XILINXD_LICENSE_FILE={self._amd_license} && ' \
                                f'source {self._amd_vitis_path}/settings64.sh && ' \
