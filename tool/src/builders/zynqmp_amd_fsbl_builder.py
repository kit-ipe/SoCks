...
class ZynqMP_AMD_FSBL_Builder(AMD_Builder):
    ...
    def __init__(
        ...
        if self.block_cfg.source == "build":
            ...
            self.block_cmds["build"].extend([self.build_fsbl, self.export_block_package, self.save_project_cfg_build])
    ...
    def build_fsbl(self):
        ...
        if not ZynqMP_AMD_FSBL_Builder._check_rebuild_bc_timestamp(
