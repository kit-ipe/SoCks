...
from amd_zynqmp_builders.zynqmp_amd_fsbl_model import ZynqMP_AMD_FSBL_Model
...
class ZynqMP_AMD_FSBL_Builder(AMD_Builder):
    ...
    def __init__(
        ...
        model_class: type[object] = ZynqMP_AMD_FSBL_Model,
    ):
        ...
        if self.block_cfg.source == "build":
            ...
            self.block_cmds["build"].extend(
                [self.build_fsbl, self.export_block_package, self._build_validator.save_project_cfg_build]
            )
