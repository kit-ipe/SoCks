...
builder_modules = ['zynqmp_amd_atf_builder_alma9', 'zynqmp_amd_uboot_builder_alma9', 'zynqmp_amd_kernel_builder_alma9', 'zynqmp_amd_vivado_hog_builder_alma9', 'zynqmp_amd_fsbl_builder_alma9', 'zynqmp_amd_pmufw_builder_alma9', 'zynqmp_amd_devicetree_builder_alma9']
builders = {}

for key0, value0 in project_cfg['blocks'].items():
    if key0 in ['atf', 'u-boot', 'kernel', 'vivado', 'fsbl', 'pmu-fw', 'devicetree']:    # ToDo: Remove. Just temporary here for testing.
        builder_found = False
