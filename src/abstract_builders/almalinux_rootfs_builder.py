...
class AlmaLinux_RootFS_Builder(File_System_Builder):
    """
    ...
    def _file_system_name(self):
        return f"almalinux{self.block_cfg.project.release}_{self.project_cfg.project.type.lower()}_{self.project_cfg.project.name}"
