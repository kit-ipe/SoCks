...
from amd_versal_support.versal_almalinux_rootfs_model import Versal_AlmaLinux_RootFS_Model


class Versal_AlmaLinux_RootFS_Builder(AlmaLinux_RootFS_Builder):
    """
