...
class AMD_UBoot_SSBL_Dependencies_Model(BaseModel):
...
class AMD_UBoot_SSBL_Block_Project_Model(Block_Project_Model):
    ...
    dependencies: AMD_UBoot_SSBL_Dependencies_Model = Block_Project_Model_Default_Fields.dependencies
...
class ZynqMP_AMD_UBoot_SSBL_Model(ZynqMP_Base_Model):
    model_config = ConfigDict(extra="forbid", strict=True)
